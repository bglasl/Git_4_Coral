...
ADONIS #not sign -> community does not vary between treatments
capture.output(ADONIS,file="Adonis_Treatment.doc")
...
anova(BETADISP) # varies between Genotype significant p=0.01852
